...
import { OpenArmLabBuilderSimulator } from './physics/openarm-lab-builder-simulator.js';
...
export class SimulatorHost {
  constructor(canvas, {
    ...
    openarmLabBuilderFactory = (target) => new OpenArmLabBuilderSimulator(target),
    ...
    this.openarmLabBuilderFactory = openarmLabBuilderFactory;
  ...
  async setScenario(profileId, scenario, fallbackRest = {}) {
    ...
    const backend = physical && profileId === 'asimov'
      ...
      : physical && profileId === 'openarm' && scenario?.labBuilder === true
      ? this.openarmLabBuilderFactory(this.canvas)
