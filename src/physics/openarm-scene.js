...
export const OPENARM_V2_PHASE5A_SCENE = Object.freeze({
  ...
  revision: 'phase5a-openarm-v2-bimanual-stack-v1',
  ...
  taskGoal: Object.freeze({
    ...
    flask: Object.freeze({
      ...
      objectGeoms: Object.freeze(['flask_body_geom', 'flask_grip_geom']),
      supportGeom: 'left_hotplate',
      targetCenterXYM: Object.freeze([0.608, 0.1535]),
      targetHalfExtentsXYM: Object.freeze([0.045, 0.045]),
      initialBodyZM: 1.085,
    }),
    beaker: Object.freeze({
      ...
      targetCenterXYM: Object.freeze([0.608, -0.1535]),
      targetHalfExtentsXYM: Object.freeze([0.040, 0.040]),
      initialBodyZM: 1.120,
    }),
...
export const OPENARM_V2_BIMANUAL_CONTROLLER = Object.freeze({
  id: 'openarm-v2-bimanual-stack-v1',
  ...
  stages: Object.freeze([
    ...
    Object.freeze({ name: 'left_close', label: 'Left gripper closes into bilateral flask contact', durationSeconds: 0.50, targetsRad: Object.freeze({ openarm_left_finger_joint1: 0 }) }),
    Object.freeze({ name: 'left_lift', label: 'Left arm lifts the contacted flask', durationSeconds: 1.00, targetsRad: armTargets('left', LEFT_LIFT, 0) }),
    Object.freeze({ name: 'left_transfer', label: 'Left arm carries the flask toward the unpowered hotplate', durationSeconds: 1.20, targetsRad: armTargets('left', LEFT_TRANSFER, 0) }),
    Object.freeze({ name: 'left_lower', label: 'Left arm lowers the held flask onto the hotplate', durationSeconds: 0.90, targetsRad: armTargets('left', LEFT_PLACE, 0) }),
    ...
    Object.freeze({ name: 'left_retreat', label: 'Left arm retreats clear of the settled flask', durationSeconds: 0.85, targetsRad: armTargets('left', LEFT_TRANSFER, 0.65) }),
    Object.freeze({ name: 'right_close', label: 'Right gripper closes into bilateral beaker contact', durationSeconds: 0.50, targetsRad: Object.freeze({ openarm_right_finger_joint1: 0 }) }),
    Object.freeze({ name: 'right_lift', label: 'Right arm lifts the contacted beaker', durationSeconds: 1.00, targetsRad: armTargets('right', RIGHT_LIFT, 0) }),
    Object.freeze({ name: 'right_transfer', label: 'Right arm carries the beaker toward the ring stand', durationSeconds: 1.20, targetsRad: armTargets('right', RIGHT_TRANSFER, 0) }),
    Object.freeze({ name: 'right_lower', label: 'Right arm lowers the held beaker onto the wire gauze', durationSeconds: 0.90, targetsRad: armTargets('right', RIGHT_PLACE, 0) }),
    ...
    Object.freeze({ name: 'right_retreat', label: 'Right arm retreats clear of the settled beaker', durationSeconds: 0.85, targetsRad: armTargets('right', RIGHT_TRANSFER, -0.65) }),
  ]),
