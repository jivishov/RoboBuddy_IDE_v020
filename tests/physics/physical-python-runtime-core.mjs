...
worker.emit({ type: 'bridge-request', runEpoch, workspaceEpoch: 4, requestId: 2, method: 'send_action', args: { targets: { shoulder_pan: 0.2 }, max_steps: 100 }, source: { file: 'main.py', line: 2 } });
await new Promise((resolve) => setTimeout(resolve, 0));
...
console.log('Physical Python worker cancellation/epoch checks: OK');
