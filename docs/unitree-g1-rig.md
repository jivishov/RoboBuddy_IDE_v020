...
The physical workspace is the profile default. It is documented in full in [unitree-g1-provenance.md](physics/unitree-g1-provenance.md), including its pinned sources, model variants, actuation law, standing evidence, negative controls and capability table.
